        ...
        <div class="row">
            <div class="col-8">
                ...
                <div class="base fuel_input">
                    <div class="head">
                        <h2 class="fuel_header">燃費計算ツール（編集画面）</h2>
                    ...
                    <form class="main_form" method="post" action="{{ url('/fuel/update') }}">
                    @csrf
                        <input type="hidden" name="id" value="{{ $new_score->id }}">
                        <div class="fuel_input_head">
                            <p class="heading">レシート等に記載の給油金額、給油量を入力してください。</p>
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <div class="controls">
                                        ...
                                        <input type="date" id="date" class="floatLabel" name="date" value="{{ $new_score->date }}">
                                    </div>      
                                    <div class="controls">
                                        <label for="distance"><i class="fa-solid fa-car-side"></i>&nbsp;&nbsp;総走行距離（㎞）</label>
                                        <input type="text" id="distance" class="floatLabel" name="distance" value="{{ $new_score->distance }}" required maxlength="6">
                                    </div>       
                                </div>
                                ...
                                <div class="col-6">
                                    <div class="controls">
                                        ...
                                        <input type="text" id="money" class="floatLabel" name="money" value="{{ $new_score->money }}" required maxlength="5">
                                    </div>
                                    <div class="controls">
                                        <label for="refueling_amount"><i class="fa-solid fa-droplet"></i>&nbsp;&nbsp;給油量（L）</label>
                                        <input type="text" id="refueling_amount" class="floatLabel" name="refueling_amount" value="{{ $new_score->refueling_amount }}" required maxlength="5">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="edit_button">
                            <button class="main_button return" type="button" onclick="history.back()">戻る</button>
                            <button class="main_button col-1-4" type="submit" value="submit">編集内容を登録する</button>
                        </div>  
                    </form>
                </div>
                ...
                <div class="base new_data_base">
                    ...
                    <div class="fuel_consumption_data">
                        <p class="no_data">上の編集画面より編集してください。</p>
                    </div>
                </div>
